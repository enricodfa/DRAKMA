...
import { incomeMonthly } from '@/lib/mock-data'
...
export default function ReceitasLineChart() {
  return (
    <div
    ...
    >
      ...
      <div className="flex-1" style={{ minHeight: 180 }}>
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={incomeMonthly} margin={{ top: 8, right: 8, left: -8, bottom: 0 }}>
            <defs>
            ...
            <Area
              ...
              strokeWidth={2}
              fill="url(#incomeGrad)"
              dot={{ fill: '#C9A86A', r: 3, strokeWidth: 0 }}
              activeDot={{ fill: '#C9A86A', r: 5, strokeWidth: 0 }}
            />
          </AreaChart>
        </ResponsiveContainer>
      </div>
