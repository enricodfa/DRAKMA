      ...
      <div className="rounded-xl p-5" style={{ backgroundColor: '#16161E', border: '1px solid #2A2A38' }}>
        ...
        <div className="flex items-start gap-3">
          <p className="text-xs leading-relaxed flex-1" style={{ color: '#9090A0' }}>
            {saldo >= 0
              ? <><span>Você está no </span><span className="font-semibold" style={{ color: '#4B9B7A' }}>positivo</span><span> esse mês. Continue assim!</span></>
              : <><span>Seus gastos superaram as receitas em </span><span className="font-semibold" style={{ color: '#E05C5C' }}>{formatCurrency(Math.abs(saldo))}</span>.</>
            }
          </p>
